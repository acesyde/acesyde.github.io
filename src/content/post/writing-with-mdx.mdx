...
Mermaid fences work here too, without importing a component:

```mermaid
sequenceDiagram
    accTitle: Serving a static post
    accDescr: The reader requests a post and the site returns the HTML generated at build time.
    Reader->>Site: Open a post
    Site-->>Reader: Return the built HTML
```
